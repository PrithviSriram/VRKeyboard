...
public class KeyboardOverlayVer2 : MonoBehaviour
{
    ...
    private KeyboardKeyVer2 m_Key = null;
    ...
    private void UpdateWidth() {
        ...
        Bounds textBounds = m_target.textBounds;
    ...
    public void Initialize(KeyboardControllerVer2 parent, KeyboardInputVer2 input) {
        m_KeyboardController = parent;
        m_target = input.input;
        debugToggle = m_KeyboardController.debugToggle;
        return;
    }
    public void Initialize(KeyboardControllerVer2 parent) {
        m_KeyboardController = parent;
        debugToggle = m_KeyboardController.debugToggle;
        return;
    }

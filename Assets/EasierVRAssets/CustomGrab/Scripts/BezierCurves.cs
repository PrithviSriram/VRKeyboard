...
public class BezierCurves : MonoBehaviour
{
    ...
    */
    public List<Vector3> DetermineLinearCurve(int numPoints, GameObject point0, GameObject point1, int startPosition = 1)
    {
    ...
    public List<Vector3> DetermineLinearCurve(int numPoints, Vector3 point0, Vector3 point1, int startPosition = 1)
    {
        List<Vector3> positions = new List<Vector3>();
        for(int i = startPosition; i <= numPoints; i++)
        {
     ...
     * - DOESN'T DRAW IT, ONLY DETERMINES POINTS
    */
    public List<Vector3> DetermineQuadraticCurve(int numPoints, GameObject point0, GameObject point1, GameObject point2, int startPosition = 1)
    {
        List<Vector3> positions = new List<Vector3>();
        for (int i = startPosition; i <= numPoints; i++)
        {
    ...
    public List<Vector3> DetermineQuadraticCurve(int numPoints, Vector3 point0, Vector3 point1, Vector3 point2, int startPosition = 1)
    {
        List<Vector3> positions = new List<Vector3>();
        for (int i = startPosition; i <= numPoints; i++)
        {
    ...
    */
    public void DrawCurve(LineRenderer renderer, List<Vector3> positions)
    {
